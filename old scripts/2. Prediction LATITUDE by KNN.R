###############################################################################
#                                                                             #
#   WIFI | TRAINING KNN  FOR LATITUDE | VERSION 6.0 | by ELSE                 #
#                                                                             #
...
trainingData <- readRDS(file = "data/trainingDataProc(V6).rds")
validationData <- readRDS(file = "data/validationDataProc(V6).rds")
...
# store as RDS
saveRDS(resultsLATITUDE, file = "resultsLATITUDE(V6).rds")
