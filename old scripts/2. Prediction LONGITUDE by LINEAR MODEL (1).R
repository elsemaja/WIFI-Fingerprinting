###############################################################################
#                                                                             #
#   WIFI | TRAINING LINEAR MODEL FOR LONGITUDE | VERSION 1.0 | by ELSE        #
#                                                                             #
...
# results <- tibble(.rows = 1111)
# results$pred_longiitude_lm <- predictedLM
# results$real_long_lm <- validationData$LONGITUDE
# results$real_latitude
