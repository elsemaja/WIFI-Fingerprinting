###############################################################################
#                                                                             #
#   WIFI | VISUALISING THE RESULTS WITH PLOTS | VERSION 3.0 | by ELSE         #
#                                                                             #
...
resultsVSactual <- readRDS(file = "resultsVSactual(3).rds")
...
summary(resultsVSactual$errorsFLOOR)
summary(resultsVSactual$errorsBUILDING)
summary(resultsVSactual$errorsLATITUDE)
summary(resultsVSactual$errorsLONGITUDE)

plot(resultsVSactual$errorsFLOOR)
plot(resultsVSactual$errorsBUILDING)
plot(resultsVSactual$errorsLATITUDE)
plot(resultsVSactual$errorsLONGITUDE)
...
PlotError3D <- plot_ly(resultsVSactual, 
                      x = ~LATITUDE, y = ~LONGITUDE, z = ~FLOOR, colors = c('#0C4B8E','#BF382A')) %>%
