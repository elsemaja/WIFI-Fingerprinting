###############################################################################
#                                                                             #
#   WIFI | TRAINING KNN MODEL FOR LONGITUDE | FINAL VERSION | by ELSE         #
#                                                                             #
...
saveRDS(wrongLONGITUDE, file = "data/errorsFLOOR-training.rds")
...
# store as RDS
saveRDS(resultsLONGITUDE, file = "data/resultsLONGITUDE(V7).rds")
